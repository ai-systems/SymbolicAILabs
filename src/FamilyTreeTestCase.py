...
class FamilyTreeTestCase(FoilTestCase):
    ...
    def loadFamilyTree1(self):
        ...
        """
        v, a = self.v, self.a
        ordering = [a.frank, a.rebecca, a.george, a.jannet, a.abe, a.alan, a.joan, a.jill, a.bob, a.tim,
                    a.tammy, a.sean, a.jan, a.tipsy, a.tom, a.jane, a.ian, a.thomas, a.debrah, a.ann, a.billy]
        ...
        for predicate in [self.mother, self.father]:
            try:
                predicate.param_orderings = determine_param_orderings(
                    predicate)
            except:
                pass
    ...
    def setUp(self):
        ...
        v, a = self.v, self.a
        self.father = RuleBasedPredicate(
            'father', (FamilyMember, FamilyMember))
        self.mother = RuleBasedPredicate(
            'mother', (FamilyMember, FamilyMember))
    ...
    def testFindRecursiveRules(self):
        ...
        mother = self.mother
        predicate = RuleBasedPredicate(
            'ancestor', (FamilyMember, FamilyMember))
        predicate.rules.append(
            Rule(predicate, (v.X, v.Y), (mother(v.X, v.Y),)))
        ...
        self.assertTrue(
            will_halt(predicate, recursive_literal, [v.X, v.Y], ordering))
    ...
    def testGrandparent(self):
        ...
        v, a = self.v, self.a
        self.loadFamilyTree1()
        grandfather = RuleBasedPredicate(
            'grandfather', (FamilyMember, FamilyMember))
        grandfather.arity = 2
        ...
        negative_tuples = [[a.jannet, a.tim],
                           ...
                           [a.rebecca, a.sean],
                           [a.jan, a.ann]]
        foil(grandfather, positive_tuples,
             negative_tuples, self.kb, ordering=None)
